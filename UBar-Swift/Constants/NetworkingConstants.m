...
NSString * kBaseUrlStr = @"https://medivh.llwz.co";

NSString * kRequestEndPointStr = @"/api/v1/request";
...
NSString * kReqRedirUrlStr = @"https://uber.codingsans.com/";

NSString * kIsTutorialLaunchedFirstTimeString = @"isfirstlaunch";
